...
import zxskelobrine.riders.biome.ChunkProvidersRider;
...
{
this.worldChunkMgr = new WorldChunkManagerHell(Riders.TutorialBiome, this.dimensionId, this.dimensionId);
this.worldChunkMgr = new WorldChunkManagerHell(Riders.IceBiome, this.dimensionId, this.dimensionId);
this.dimensionId = Riders.DimID;
this.hasNoSky = false;
}
public IChunkProvider createChunkGenerator()
{
return new ChunkProvidersRider(this.worldObj, this.worldObj.getSeed(), false);
}
...
{
if ((this instanceof WorldProviderFire))
{
