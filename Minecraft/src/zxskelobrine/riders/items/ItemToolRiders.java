package zxskelobrine.riders.items;
...
public class ItemToolRiders extends Item
{
    ...
    protected RidersToolMat toolMaterial;

    protected ItemToolRiders(int par1, float par2, RidersToolMat par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
