package zxskelobrine.riders.blocks.ice;
...
public class BlockIceRide extends BlockFire
{
...
if ((par1World.getBlockId(par2, par3 - 1, par4) != Riders.fireStone.blockID) || (!(Riders.portalRide.portal).tryToCreatePortal(par1World, par2, par3, par4))) 
{
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
{
par1World.setBlockToAir(par2, par3, par4);
...
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
{
if (((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
{
for (int l = 0; l < 2; l++)
{
...
if (((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
{
for (int l = 0; l < 2; l++)
{
...
if (((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
{
for (int l = 0; l < 2; l++)
{
...
if (((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
{
for (int l = 0; l < 2; l++)
{
float f = par2 + par5Random.nextFloat();
...
if (((BlockFire) Riders.fireRide).canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
{
for (int l = 0; l < 2; l++)
{
float f = par2 + par5Random.nextFloat();
...
{
 this.iconArray = new Icon[] {par1IconRegister.registerIcon("riders" + ":" + "MHFfire"+"_0"), par1IconRegister.registerIcon("riders" + ":" + "MHFfire_"+"1")};
}
@SideOnly(Side.CLIENT)
