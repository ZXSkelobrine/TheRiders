...
import zxskelobrine.riders.dimesion.TeleporterRider;
...
public class BlockPortalRide extends BlockBreakable
{
public BlockPortalRide(int par1)
{
super(par1, "riders:portal", Material.portal, false);
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != Riders.fireRide.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Riders.portalRide.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != Riders.DimID)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Riders.DimID, new TeleporterRider(thePlayer.mcServer.worldServerForDimension(Riders.DimID)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterRider(thePlayer.mcServer.worldServerForDimension(0)));
         }
         }
}
@SideOnly(Side.CLIENT)
